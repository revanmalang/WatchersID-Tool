...
Thank you for taking an interest in WatchersID! If you want to contribute to the
...
Use [issues](https://github.com/watchers-id/watchersid/issues) for reporting bugs,
adding feature requests and giving context to PRs you submit. Please use [labels](https://github.com/watchers-id/watchersid/labels)
in favor of category prefixes in issue titles. To keep the issue tracker
focused on development, use [discussions](https://github.com/watchers-id/watchersid/discussions)
...
changes the behavior of WatchersID, please consider first using [discussions](https://github.com/watchers-id/watchersid/discussions)
