...
func init() {
	...
	gob.RegisterName("github.com/watchers-id/watchersid/pkg/search.PrefixExpression", PrefixExpression{})
	gob.RegisterName("github.com/watchers-id/watchersid/pkg/search.InfixExpression", InfixExpression{})
	gob.RegisterName("github.com/watchers-id/watchersid/pkg/search.StringLiteral", StringLiteral{})
	gob.RegisterName("github.com/watchers-id/watchersid/pkg/search.RegexpLiteral", RegexpLiteral{})
}
